...
Once the instance is setup, you might want to follow these instructions [here](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/putty.html) to set up PuTTY (for Windows users) and obtain a .pem key. Once we are logged into PuTTY we can run the following commands into the terminal:

<center>
![yunohurry](y_u_no_hurry_up.jpg)
</center>
